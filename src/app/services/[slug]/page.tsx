...
const ServicePage = ({ params }: ServicePageProps) => {
  ...
  if (notFound) {
    return (
      <div className="w-full h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-gray-600 mb-4">Service Not Found</h2>
        ...
        <div className="max-w-screen mx-auto lg:px-12 sm:px-6 px-4 md:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center min-h-screen py-12">
            ...
            <div className="relative overflow-hidden rounded-2xl">
              <img
                src={service.images?.[0] || "https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d?w=400&h=200&fit=crop"}
                alt={service.title}
